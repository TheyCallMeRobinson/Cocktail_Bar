...
class GetCocktailByTitleUseCase(private val cocktailRepository: CocktailRepository) {

    suspend fun execute(title: String): CocktailEntity {
        return cocktailRepository.getByTitle(title)
    }
}